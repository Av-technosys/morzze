...
export const DriftWall = ({
  ...
  return (
    ...
    >
      <div
        ref={planeRef}
        className="absolute left-1/2 scale-110 -translate-x-[5%] top-1/2 flex cursor-pointer flex-row [transform-style:preserve-3d] [transform-origin:50%_50%] will-change-transform"
      >
